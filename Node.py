...
class Node: 
    def __init__(self, feature_count=None, left_child=None, right_child=None, parent=None, value=None, splid_value=None):
        ...
        self.splid_value = splid_value #value of the split of the node 
